...
WiringPi / WiringOP libary for the Orange Pi zeroplus H5 with 26 pin GPIO header

This is a modified WiringPi for specially OrangePi zeroplus H5. 

GPIO is fully working, i2c and Spi not testet yet!


## Installation
    cd WiringOP_zeroplus_h5
    chmod +x ./build
    sudo ./build

## Test
```    
 +-----+-----+----------+------+--Orange Pi zeroplus H5--+---+------+---------+-----+--+
