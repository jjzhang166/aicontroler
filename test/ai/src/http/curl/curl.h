...
(*curl_opensocket_callback)(void *clientp, curlsocktype purpose,
...
typedef enum
{
	CURLINFO_TEXT = 0, CURLINFO_HEADER_IN, /* 1 */
...
typedef enum
{
	CURLE_OK = 0, CURLE_UNSUPPORTED_PROTOCOL, /* 1 */
	CURLE_FAILED_INIT, /* 2 */
...
enum curl_khstat
{
	CURLKHSTAT_FINE_ADD_TO_FILE, CURLKHSTAT_FINE, CURLKHSTAT_REJECT, /* reject the connection, return an error */
...
enum CURL_TLSAUTH
{
	CURL_TLSAUTH_NONE, CURL_TLSAUTH_SRP, CURL_TLSAUTH_LAST /* never use, keep last */
};
...
typedef enum
{
	...
	CURL_TIMECOND_IFMODSINCE, CURL_TIMECOND_IFUNMODSINCE, CURL_TIMECOND_LASTMOD,
